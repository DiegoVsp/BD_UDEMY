...
select departamento, count(*)as "Quantidade por departamento" from funcionarios where departamento = 'Roupas' or departamento = 'Filmes' group by departamento;
select departamento, count(*) as "Quantidade por departamento" from funcionarios where departamento = 'Roupas' or departamento = 'Filmes' group by departamento order by 1;
select departamento from funcionarios;
select nome, sexo as Feminino from funcionarios where sexo = 'Feminino' and (departamento = 'Lar' or departamento = 'Filmes');
select count(*), departamento from funcionarios where departamento = "Lar" or departamento = "Filmes" group by departamento;
